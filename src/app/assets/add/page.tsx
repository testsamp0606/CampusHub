...
export default function AddAssetPage() {
  ...
  useEffect(() => {
    const uniqueId = `ASSET${Date.now().toString().slice(-6)}`;
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          Fill out the form below to add a new asset. Fields marked with <span className="text-destructive">*</span> are required.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
