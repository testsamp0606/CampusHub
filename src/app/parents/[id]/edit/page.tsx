...
export default function EditParentPage() {
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        <CardTitle>Edit Parent/Guardian</CardTitle>
        <CardDescription>
          Update the information below. Fields marked with <span className="text-destructive">*</span> are required.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            render={({ field: { value, onChange, ...field } }) => (
                ...
                <FormDescription>
                    Upload a new profile picture for the parents.
                </FormDescription>
                <FormMessage />
                </FormItem>
            )}
